"""
Django settings for smartchickapp project.
...
SECRET_KEY = 'django-insecure-&9*@9bvrac%q8qh$*jkafcj1$lrsf$f$r+9ew*m-0!sgj_*7dc'
...
ROOT_URLCONF = 'smartchickapp.urls'
...
WSGI_APPLICATION = 'smartchickapp.wsgi.application'
